...
# Only direct-name matches included; loose matches (e.g. paper "hallucinating"
# vs legacy "hallucination" MWE) deliberately skipped — datasets were built
# under different protocols, mixing them silently would muddy the signal.
